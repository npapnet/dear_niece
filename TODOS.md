...
In order to get better values for the weights of the high_end metric (or a better statistic/metric), a neural network could be trained to predict the next weights given the previous ones.
